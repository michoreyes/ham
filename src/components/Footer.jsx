    ...
    <footer className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
			<div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
				<div className="flex-1 flex flex-col justify-start mr-10">
					<img src={logo} alt="ham" className='w-[266px] h-[100px] object-contain'/>
				</div>
						...
						<div className="flex flex-col ss:my-0 my-4 min-w-[150px]" key={footerLink.key}>
							...
							<ul className='list-none mt-4'>
								{footerLink.links.map((link, index) => (
									...
									cursor-pointer ${index !== footerLink.links.length-1 ? 'mb-4' : 
										'mb-0'}`}>
											{link.name}
									</li>
								))}
			...
			flex-col pt-6 border-t-[1px] border-t-white'>
				<p className='font-poppins font-normal text-[18px] text-center 
				leading-[27px] text-white'>2024 HAM Digital Marketing Service. 
